...
window.title("Python IDE made by Sparsh Agarwal")
# create and configure menu
menu = Menu(window)
window.config(menu=menu)
Label1 = Label(window, text ="A great IDE by Sparsh Agarwal", ).pack()
...
file_menu.add_separator()
file_menu.add_command(label="Exit", accelerator="Alt+F4", command=close)
